...
const TABLE_NAME = 'db.MembershipFormSignature';

const getMembershipFormSignature = async (req, res) => {
...
const getMembershipFormSignatureById = async (req, res) => {
    const { id } = req.params;
    try {
        const client = await pool.connect();
...
const addMembershipFormSignature = async (req, res) => {
...
const updateMembershipFormSignature = async (req, res) => {
    const { id } = req.params;
...
const deleteMembershipFormSignature = async (req, res) => {
    const { id } = req.params;
    try {
        const client = await pool.connect();
...
module.exports = {
    getMembershipFormSignature,
    getMembershipFormSignatureById,
    addMembershipFormSignature,
    updateMembershipFormSignature,
    deleteMembershipFormSignature
};